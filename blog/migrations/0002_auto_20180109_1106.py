# Generated by Django 2.0 on 2018-01-09 03:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='category',
            name='slug',
            field=models.CharField(default='', max_length=150, null=True, verbose_name='分类别名'),
        ),
        migrations.AddField(
            model_name='post',
            name='author',
        ...
        migrations.AddField(
            model_name='tag',
            name='slug',
            field=models.CharField(default='', max_length=150, null=True, verbose_name='标签别名'),
        ),
        ...
        migrations.AlterField(
            model_name='post',
            name='slug',
            field=models.CharField(default='', max_length=150, null=True, verbose_name='文章别名'),
        ),
        migrations.AlterField(
            model_name='tag',
            name='created_time',
